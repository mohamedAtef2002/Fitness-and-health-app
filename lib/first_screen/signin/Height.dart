...
class _HeightState extends State<Height> {
                    ...
                    child: SizedBox(
                      child: MaterialButton(
                        onPressed: () async {
                          ...
                          if (finalValue > 0) {
                            // Add height along with user ID to Firestore
                            await addHeightToFirestore(finalValue);
  ...
  // Add height along with user ID to Firestore
  Future<void> addHeightToFirestore(double height) async {
    try {
      ...
      if (user != null) {
        ...
        print('Height added to Firestore: $height');
      } else {
        print('User is not logged in!');
      }
    } catch (e) {
      print('Error adding height to Firestore: $e');
    }
  }
}
