...
class _DinnerState extends State<Dinner> {
  ...
  Widget build(BuildContext context) {
    if (dietPlan.isEmpty || !dietPlan.containsKey('Dinner')) {
      return Center(child: Text("No data available"));
    }

    var dinnerData = dietPlan["Dinner"];
    return SizedBox(
      height: 400,
      child: ListView.builder(
        ...
        itemCount: dinnerData.length, // Number of horizontal items
        itemBuilder: (context, index) {
          String day = dinnerData.keys.elementAt(index);
          Map<String, dynamic> meals = dinnerData[day];
          return Padding(
