...
class _SnakState extends State<Snak> {
  ...
  Widget build(BuildContext context) {
    if (dietPlan.isEmpty || !dietPlan.containsKey('Snack')) {
      return Center(child: Text("No data available"));
    }

    var snackData = dietPlan["Snack"];
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: snackData.length, // Number of days
        itemBuilder: (context, index) {
          String day = snackData.keys.elementAt(index);
          Map<String, dynamic> meals = snackData[day];
